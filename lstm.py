...
def plot_results(predicted_data, true_data, filename):
    ...
    #    point_by_point_predictions[i] = point_by_point_predictions[i] + random.uniform(-0.15,0.15)
...
if __name__=='__main__':
    ...
    X_train, y_train, X_test, y_test = load_data('1.csv', seq_len, True)
    ...
    model.fit(X_train,y_train,batch_size=10,nb_epoch=epochs,validation_split=0.01)
